...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:tet-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Mayank</span>
                Rajput <br />Software Engineer
                <span class="poppins text-violet-400"> Intern</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400">favorite tech </span> includes Kotlin
                , Java , Flutter and C++ , Firebase , MySQL.
            </p>
            <a
        ...
        <div class="relative shadow-2xl grid place-items-center">
            <img
                src={"images/pfp.png"}
                alt="Profile Picture"
                class="object-cover z-[2] max-h-[70vh] align"
            />
        </div>
    </section>
    ...
    <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
        ...
        <a
            href="#"
            target="_blank"
            class="mx-auto px-4 py-2 rounded-md border-solid border-white flex items-center gap-2 -mb-4 sm:-mb-0 -mt-10 hover:border-violet-700 duration-200"
        >
            <i class="fa-regularfa-circle-play" />
            <p>Watch the video</p>
        </a>
            ...
            <Step step={steps[0]}>
                <p>
                    This project Lorem Ispum qeador <strong
                        class="text-violet-400">Firebase or highlighted</strong
    ...
    >
        ...
        >
            ...
            <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">
                A bit <span class="poppins text-violet-400">about</span>
            </h3>
        </div>
